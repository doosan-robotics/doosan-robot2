...
def main(args=None):
    ...
    p2= posj(0, 0, 90, 0, 90, 0)   #joint pos

    x1= posx(400.0, 500.0, 800.0, 0.0, 180.0, 0.0) #task pos
    x2= posx(400.0, 500.0, 500.0, 0.0, 180.0, 0.0) #task pos
    ...
    while rclpy.ok(): 
        ...
        time.sleep(1)
        movel(x1, vel=100.0, acc=100.0)
        movel(x2, vel=100.0, acc=100.0)
        time.sleep(1)
