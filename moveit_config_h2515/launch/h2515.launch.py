...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file('moveit_config_h2515', 'config/h2515.srdf')
    robot_description_semantic = {'robot_description_semantic' : robot_description_semantic_config}

    kinematics_yaml = load_yaml('moveit_config_h2515', 'config/kinematics.yaml')
    ...
    ompl_planning_yaml = load_yaml('moveit_config_h2515', 'config/ompl_planning.yaml')
    ompl_planning_pipeline_config['move_group'].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    controllers_yaml = load_yaml('moveit_config_h2515', 'config/controllers.yaml')
    ...
    fake_joint_driver_node = Node(package='fake_joint_driver',
                                  ...
                                  parameters=[{'controller_name': 'dsr_joint_trajectory_controller'},
                                              os.path.join(get_package_share_directory("moveit_config_h2515"), "config", "fake_controllers.yaml"),
                                              os.path.join(get_package_share_directory("moveit_config_h2515"), "config", "start_positions.yaml"),
                                              robot_description]
                                  )
